...
If you are subject to or witness unacceptable behavior, or have any other concerns, please notify the organizing team as soon as possible by messaging them:

- Ramón Huidobro (talk.to@ramonh.dev)
...
This guideline and its related procedures also applies to unacceptable behavior occurring outside the scope of the Study Jams activities when such behavior has the potential to adversely affect the safety and well-being of attendees.
